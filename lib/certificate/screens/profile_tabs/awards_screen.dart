          ...
          Expanded(
            child: Padding(
              ...
              child: FutureBuilder<dynamic>(
                future: contractFactory.getFilteredUserProducts("Awards"),
                builder: (BuildContext context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Center(
                      child:
                      emptyWidget(context, text: 'Awards list is empty'),
                    );
                  }
          ...
          Container(
            ...
            child: FullButton(
              onPressed: () async {
                 ...
                 await homeProvider.showAddCertificateDialog(context,"Awards");
