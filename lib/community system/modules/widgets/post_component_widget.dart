      ...
      children: [
        ListTile(
          ...
          leading: CircleAvatar(
            backgroundImage: NetworkImage(model.postMakerImage.toString()),
          ),
          title: Text(
            model.communityName.toString(),
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17.sp),
          ),
          subtitle: Text(
            "${model.postMakerName.toString()}, ${model.postDate.toString()}",
        ...
        if (model.postCaption != null)
          InkWell(
            ...
            child: Text(model.postCaption.toString(),
                maxLines: 2,
          ...
          InkWell(
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                ...
                imageUrl: model.postImage.toString(),
            ...
            children: [
              GestureDetector(
                child: Icon(Icons.favorite,
                    color:
                        likesStatus[postID] == true ? Colors.red : Colors.grey),
                onTap: () {
                  ...
                  setState(() {
                    if (likesStatus[postID] == true) {
                      ...
                      cubit.removeLike(
                          ...
                          postMakerID: model.postMakerID!,
                          postID: postID,
                          communityAuthorID: model.communityAuthorID!);
                    } else {
    ...
    return GestureDetector(
      ...
      onTap: () {
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    EditPostScreen(model: model, postID: postID)));
      },
    );
  }
